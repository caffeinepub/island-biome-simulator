...
export class Backend implements backendInterface {
    ...
    async getLast10Records(): Promise<Array<SimulationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLast10Records();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async saveSimulationRecord(arg0: bigint, arg1: bigint, arg2: bigint, arg3: bigint, arg4: bigint, arg5: bigint, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSimulationRecord(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
